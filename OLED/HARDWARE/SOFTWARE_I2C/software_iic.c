...
{			
  GPIO_InitTypeDef  GPIO_InitStructure;
	...
	RCC_AHB1PeriphClockCmd(IIC2_SCL_GPIO_RCC, ENABLE);//使能GPIOB时钟
	RCC_AHB1PeriphClockCmd(IIC2_SDA_GPIO_RCC, ENABLE);//使能GPIOB时钟
  ...
  GPIO_Init(IIC2_SDA_GPIO_PORT, &GPIO_InitStructure);//初始化
	
	GPIO_InitStructure.GPIO_Pin = IIC2_SCL_GPIO_PIN;
	GPIO_Init(IIC2_SCL_GPIO_PORT, &GPIO_InitStructure);//初始化
