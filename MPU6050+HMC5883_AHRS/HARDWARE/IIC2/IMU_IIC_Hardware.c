...
{   
	...
	I2C_Send7bitAddress(I2C2,(ADDR<<1) | 0,I2C_Direction_Transmitter);                        //发送器件地址 
...
//***********IIC多字节读函数********************************************//
u8 Hardware_Read_Byte(u8 ADDR,u8 reg,u8 len,u8 *buf)                                //需要两个起始信号
{  
	delay_ms(2);
	I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	I2C_Send7bitAddress(I2C2, (ADDR<<1)|0, I2C_Direction_Transmitter);                       //写入器件地址
	I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	I2C_Send7bitAddress(I2C2, (ADDR<<1)|1, I2C_Direction_Receiver);                          //将器件地址传出，主机为读
	I2CTimeout = I2CT_FLAG_TIMEOUT;
